...
if not os.path.exists(config_path):
    ...
    print("Generate it with the fiverr-gig-optimizer skill, or copy references/config-example.json and edit it.")
    sys.exit(1)
...
<div class="credit">
  Generated with the <strong>Fiverr Gig Optimizer</strong> skill for Claude Code
</div>
